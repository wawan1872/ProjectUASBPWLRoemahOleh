                            ...
                            <div class="container ">
                                <table class="table">
                                    ...
                                    <tr class="table-light">
                                        <td><?php echo $no++ ?></td>
                                        <td><?php echo $usr->id_pembeli ?></td>
                                        <td><?php echo $usr->username ?></td>
                                        <td><?php echo $usr->alamat ?></td>
                                        <td><?php echo $usr->password ?></td>
                                        <td onclick="javascript: return confirm('Anda yakin hapus data ini?') ">
                                            <?php echo anchor('index.php/user_c/aksi_hapus/'.$usr->id_pembeli, '<div class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</div>') ?>
                                        </td>
										<td>
											
										<?php echo anchor('/user_c/aksi_edit/'.$usr->id_pembeli, '<div class="btn btn-info"><i class="fa fa-edit"></i> Edit</div>') ?>
										</td>
                                    </tr>
                                    <?php endforeach; ?>
                                </table>
