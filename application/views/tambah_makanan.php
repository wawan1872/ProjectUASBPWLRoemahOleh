	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item active">
				<a class="nav-link" href="<?php echo base_url('index.php/welcome/masuk');?>">
			...
			<div id="content">
				...
				<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle" href="<?php echo base_url()?>assets/#" id="userDropdown"
							...
							<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
								...
								<a class="dropdown-item" href="<?php echo base_url()?>assets/#" data-toggle="modal"
				...
				<div class="container-fluid">
					...
					<div class="container-fluid px-4">
						...
						<div class="container ">
							<div>
								<?php echo form_open_multipart('makanan_c/aksi_input'); ?>
								<input type="hidden" name="id_makanan" placeholder="Id" class="form-control" value="id_makanan">
							</div><br>
							<div class="form-group">
								<label>Id Makanan</label>
								<br>
								<input type="text" name="id_makanan" placeholder="" class="form-control">
							</div><br>
							<div class="form-group">
