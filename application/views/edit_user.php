				...
				<div class="container-fluid">
					...
					<div class="container ">
						<div>
							...
							<form action="<?php echo base_url().'/user_c/update' ?>" method="post" >
								<input type="hidden" name="id_pembeli" placeholder="Id_pembeli"
									class="form-control rounded-pill mt-3 mb-3" value="<?php echo $usr->id_pembeli ?>">
						</div><br>
						<div class="form-group">
							<label>username</label>
							<br>
							<input type="text" name="username" class="form-control rounded-pill mt-3"
								value="<?php echo $usr->username ?>">
						</div><br>
						<div class="form-group">
							<label>Alamat </label>
							<br>
							<input type="text" name="alamat" class="form-control rounded-pill mt-3"
								value="<?php echo $usr->alamat ?>">
						</div><br>
						<div class="form-group">
							<label>Password</label>
							<br>
							<input type="text" name="password" class="form-control rounded-pill mt-3"
								value="<?php echo $usr->password ?>">
						</div><br>

						<div class="form-group">
							<button class="btn btn-success mt-3 baris2" name="Submit"><i class="fa fa-plus"></i>
								Simpan</button>
							<a href="<?php echo base_url('/welcome/data_user'); ?>"
