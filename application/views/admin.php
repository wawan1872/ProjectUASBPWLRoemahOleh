...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('welcome/data_user');?>">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-4">
							<div class="card">
								<p>Berikut adalah Data User</p>
								<a class="btn btn-primary" href="<?php echo base_url('welcome/data_user');?>">Data User </a>
							</div>
						</div>

						<div class="col-4">
							<div class="card" style="">
								<p>Berikut adalah Data Pesanan</p>
								<a class="btn btn-primary" href="<?php echo base_url('welcome/data_pesanan');?>">Open</a>
							</div>
						</div>

						<div class="col-4">
							<div class="card" style=";">
								<p> Berikut adalah data list kue </p>
								<a class="btn btn-primary" href="<?php echo base_url('welcome/data_makanan');?>">Open</a>
							</div>
						</div>
					</div>
