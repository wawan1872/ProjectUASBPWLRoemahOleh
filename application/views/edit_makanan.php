		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="container ">
						<div>
							<?php foreach($d_makanan as $mkn): ?>
							<form action="<?php echo base_url().'/makanan_c/update' ?>" method="post" >
								<input type="hidden" name="id_makanan" placeholder="Id_makanan"
									class="form-control rounded-pill mt-3 mb-3" value="<?php echo $mkn->id_makanan ?>">
						</div><br>
						<div class="form-group">
							<label>Nama Makanan</label>
							<br>
							<input type="text" name="nama" class="form-control rounded-pill mt-3"
								value="<?php echo $mkn->nama ?>">
						</div><br>
						<div class="form-group">
							<label>Stock </label>
							<br>
							<input type="text" name="stock" class="form-control rounded-pill mt-3"
								value="<?php echo $mkn->stock ?>">
						</div><br>
						<div class="form-group">
							<label>Harga</label>
							<br>
							<input type="text" name="harga" class="form-control rounded-pill mt-3"
								value="<?php echo $mkn->harga ?>">
						</div><br>

						<div class="form-group">
							<button class="btn btn-success mt-3 baris2" name="Submit"><i class="fa fa-plus"></i>
								Simpan</button>
							<a href="<?php echo base_url('/welcome/data_makanan'); ?>"
