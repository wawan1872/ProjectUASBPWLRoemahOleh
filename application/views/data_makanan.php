			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="container-fluid px-4">
						<h1 class="mt-4">List Kue</h1>
						<ol class="breadcrumb mb-4">
							<li class="breadcrumb-item active"></li>
						</ol>
						<div class="container-fluid">
							<div class="row">
								<a href="<?php echo base_url('/welcome/tambah_makanan'); ?>" class="btn btn-success"
									style="width: 15%; margin-left:1%"><i class="fa fa-plus"></i> Tambah List Kue</a>
								...
								<div class="container ">
									<table class="table">
										...
										<?php
                                    $no = 1;
                                    foreach ($d_makanan as $mkn):
                                    ?>
										<tr class="table-light">
											<td><?php echo $no++ ?></td>
											<td><?php echo $mkn->id_makanan ?></td>
											<td><?php echo $mkn->nama ?></td>
											<td><?php echo $mkn->stock ?></td>
											<td><?php echo $mkn->harga ?></td>
											<td onclick="javascript: return confirm('Anda yakin hapus data ini?') ">
												<?php echo anchor('index.php/makanan_c/aksi_hapus/'.$mkn->id_makanan, '<div class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</div>') ?>
											</td>
											<td onclick="javascript: return confirm('Anda yakin edit data ini?') ">
												<?php echo anchor('/makanan_c/aksi_edit/'.$mkn->id_makanan, '<div class="btn btn-info"><i class="fa fa-edit"></i> Edit</div>') ?>
							...
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<a class="btn btn-primary"
										href="<?php echo base_url()?>assets/login.html">Logout</a>
								</div>
							</div>
						</div>
					</div>
